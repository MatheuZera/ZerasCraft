...
// 3. Som 'card' no HOVER
const HOVER_CARD = [".mc-collectible-card",".gallery-item", ".game-card2", ".mode-card", ".mc-news-card", ".f-card", ".w-item", ".game-card-simple", ".content-item", ".link-item", ".game-card", ".software-card"];

// 4. Som 'select' no HOVER (Links de texto)
const HOVER_SELECT = [".znav-item", ".footer-col a", ".mc-link-all", "p a", ".promo-box", ".link-btn-card", ".dl-card", ".testi-card", ".news-card", ".t-row-elite", ".sidebar-link", ".feature-tag", ".btn-demo ", ".dropdown-link", ".table-item", ".fab-button", ".dl-link"];
