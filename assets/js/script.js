...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const musicPlaylist = [
        ...
        { title: 'Blocks', src: 'assets/audios/musics/records/Blocks.ogg' },
        { title: 'Cat', src: 'assets/audios/musics/records/Cat.ogg' },
        { title: 'Far', src: 'assets/audios/musics/records/Far.ogg' },
        { title: 'Mall', src: 'assets/audios/musics/records/Mall.ogg' },
        { title: 'Mellohi', src: 'assets/audios/musics/records/Mellohi.ogg' },
        { title: 'Otherside', src: 'assets/audios/musics/records/Otherside.ogg' },
        { title: 'Pingstep Master', src: 'assets/audios/musics/records/Pingstep_Master.ogg' },
        { title: 'Relic', src: 'assets/audios/musics/records/Relic.ogg' },
        { title: 'Stal', src: 'assets/audios/musics/records/Stal.ogg' },
        { title: 'Strad', src: 'assets/audios/musics/records/Strad.ogg' },
        { title: 'Wait', src: 'assets/audios/musics/records/Wait.ogg' },
        { title: 'Ward', src: 'assets/audios/musics/records/Ward.ogg' },
    ];
