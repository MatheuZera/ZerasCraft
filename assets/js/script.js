...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const musicPlaylist = [
        ...
        { title: 'Moog City', src: 'assets/audios/musics/Moog-City 2.mp3' },
        ...
        { title: 'Blocks', src: 'assets/audios/musics/records/Blocks' },
        { title: 'Cat', src: 'assets/audios/musics/records/Cat' },
        { title: 'Far', src: 'assets/audios/musics/records/Far' },
        { title: 'Mall', src: 'assets/audios/musics/records/Mall' },
        { title: 'Mellohi', src: 'assets/audios/musics/records/Mellohi' },
        { title: 'Otherside', src: 'assets/audios/musics/records/Otherside' },
        { title: 'Pingstep Master', src: 'assets/audios/musics/records/Pingstep_Master' },
        { title: 'Relic', src: 'assets/audios/musics/records/Relic' },
        { title: 'Stal', src: 'assets/audios/musics/records/Stal' },
        { title: 'Strad', src: 'assets/audios/musics/records/Strad' },
        { title: 'Wait', src: 'assets/audios/musics/records/Wait' },
        { title: 'Ward', src: 'assets/audios/musics/records/Ward' },
    ];
