document.addEventListener('DOMContentLoaded', () => {
    ...
    // =====================================
    // 1. Funcionalidade da Galeria
    // =====================================
    const galleryItems = document.querySelectorAll('.gallery-item');
    if (galleryItems.length > 0) {
        // Cria dinamicamente um modal para exibir as imagens da galeria em tamanho maior.
    ...
    // =====================================
    // 2. Funcionalidade do Acordeão
    // =====================================
    const accordionButtons = document.querySelectorAll('.acordeao-btn');
    ...
    // =====================================
    // 3. Funcionalidade da Barra de Progresso
    // =====================================
    ...
    if (progressBarContainers.length > 0) {
        progressBarContainers.forEach(container => {
            ...
            if (progress) {
                // Anima a barra de progresso após um pequeno atraso.
                setTimeout(() => {
    ...
    // =====================================
    // 4. Funcionalidade de Abas
    // =====================================
    const tabsContainer = document.querySelector('.abas-container');
    if (tabsContainer) {
        const tabButtons = tabsContainer.querySelectorAll('.aba-btn');
        const tabPanels = tabsContainer.querySelectorAll('.aba-painel');
